...
class NonTituSheet extends StatefulWidget {
  ...
  @override
  State<NonTituSheet> createState() => _NonTituSheetState();
}

class _NonTituSheetState extends State<NonTituSheet> {
  ...
  void initState() {
    ...
    posteController.text =
        BlocProvider.of<UsersBlocBloc>(context).currentUser!.poste;
  }
...
class NonTituBottomFilter extends StatefulWidget {
  final Recherche recherche;
  NonTituBottomFilter({Key? key, required this.recherche}) : super(key: key);

  @override
  State<NonTituBottomFilter> createState() => _NonTituBottomFilterState();
}
