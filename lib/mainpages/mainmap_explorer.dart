...
import '../bloc/pharmacierecherche_bloc.dart' as phar;
import '../pharmacyProfile/textfield.dart';
import '../utils/map_utils.dart';

class MainmapExplorer extends StatefulWidget {
  ...
  @override
  State<MainmapExplorer> createState() => _MainmapExplorerState();
}

class _MainmapExplorerState extends State<MainmapExplorer> {
  final places =
        ...
        children: [
          TextField(
            ...
            onSubmitted: (val) async {
             BlocProvider.of<off.OffresBloc>(context).add(off.RechercheLibre(
              input: val
                              ));
                BlocProvider.of<mem.MembresBloc>(context).add(mem.RechercheLibre(
              input: val));
          BlocProvider.of<phar.PharmacierechercheBloc>(context).add(
              phar.RechercheLibre(
                input: val));
