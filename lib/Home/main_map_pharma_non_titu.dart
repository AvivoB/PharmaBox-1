...
class MainMapPharmaNonTitu extends StatefulWidget {
  ...
  @override
  State<MainMapPharmaNonTitu> createState() => _MainMapPharmaNonTituState();
}

class _MainMapPharmaNonTituState extends State<MainMapPharmaNonTitu> {
  final places =
